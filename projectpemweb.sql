...
INSERT INTO `barang` (`barangId`, `barangNama`, `details`, `categoryId`, `brandId`, `hargaJual`, `stock`, `aksesBarang`, `promoId`, `gambar`) VALUES
...
(27, 'MSI X99A Gaming Pro Carbon (LGA2011v3, X99, DDR4) - CLEARANCE SALE', '', 5, 18, 4120000, 5, 1, 3, ''),
...
(1, 'MarioWibu', '5994471ABB01112AFCC18159F6CC74B4F511B99806DA59B3CAF5A9C173CACFC5', 'Mario', 'Wibu', 'mariowibu@gmail.com', '0888888888888888', 50000, 'Jl. Sesama Ngen', 1, 'Not Available Yet'),
...
ALTER TABLE `barang`
  ...
  ADD UNIQUE KEY `barangNama` (`barangNama`),
...
ALTER TABLE `brand`
  ...
  ADD UNIQUE KEY `brandNama` (`brandNama`);
...
ALTER TABLE `category`
  ...
  ADD UNIQUE KEY `categoryNama` (`categoryNama`),
  ADD UNIQUE KEY `categoryNama_2` (`categoryNama`);
